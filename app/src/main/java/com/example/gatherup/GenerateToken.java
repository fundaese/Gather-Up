...
class GenerateToken {
   ...
   /* public static String generateProvisionToken(String key, String jid, String expires) throws NumberFormatException {
        String payload = TextUtils.join(DELIM, new String[]{PROVISION_TOKEN, jid, expires});
        return new String(Base64.encodeBase64(
                (TextUtils.join(DELIM, new String[] {payload, HmacUtils.hmacSha384Hex(key, payload)}).getBytes()
        )));
    } */

    public static String generateProvisionToken(String key, String jid, String expires) throws NumberFormatException {
        String payload = PROVISION_TOKEN + DELIM + jid + DELIM + expires;
        return new String(Base64.encodeBase64(
